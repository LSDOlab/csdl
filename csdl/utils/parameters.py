...
class Parameters(object):
    ...
    #         default = options['val'] if options[
    #             'val'] is not _UNDEFINED else '**Required**'
    ...
    #             acceptable_types = [
    #                 type_.__name__ for type_ in acceptable_types
    #             ]

    #         desc = options['desc']

    #         tlist.append(
    #             [key, default, acceptable_values, acceptable_types, desc])

    #     return tabulate(tlist,
    #                     headers='firstrow',
    #                     tablefmt=fmt,
