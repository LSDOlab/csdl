...
class CotanhComp(ExplicitComponent):
    '''
    This is a component that computes the hyperbolic cotangent using 1/numpy.tanh()
    ...
    def compute(self, inputs, outputs):
        in_name = self.options['in_name']
        out_name = self.options['out_name']
        outputs[out_name] = (1.0 / np.tanh(inputs[in_name]).flatten())
