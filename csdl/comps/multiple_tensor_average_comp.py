...
class MultipleTensorAverageComp(ExplicitComponent):
    ...
    Option 1: If the input contains multiple tensors all of which have the same dimension, without any axis provided, the component computes the average of all the tensors elementwise. Output is a tensor with the same dimension as the input.
    Option 2: If the input contains multiple tensors all of which have the same dimension, with axis/axes specified, the component computes the average of all the elements of each matrix along the specified axis/axes, and then computes the average of all the resulting vectors elementwise. Output is a tensor whose shape correspond to the shape of the input tensors with the size/s of the specified axis/axes removed.
    ...
    axis: tuple
        Axis/axes along which the average is computed when the inputs are matrices.
    out_name: str
