...
class ErrorWrongShape(Model):
    ...
    def define(self):
        ...
        # model should not auto-promote as 'f' and 'a' have different shapes
...
class ErrorCycleTwoModels(Model):
    ...
    def define(self):
        ...
        d = self.declare_variable('d')
        self.register_output('b', d+1.0)  # b is an input to 'model', creating a cycle
...
class ErrorTwoModelsPromoted(Model):
    ...
    def define(self):
        ...
        self.add(
            AdditionFunction(),
            promotes=['b', 'f'],  # can't promote model2.f as we promoted model.f
            name='model2')
