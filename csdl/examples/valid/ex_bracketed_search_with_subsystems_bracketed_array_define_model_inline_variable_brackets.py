def example(Simulator):
    ...
    class ExampleWithSubsystemsBracketedArrayDefineModelInlineVariableBrackets(
            Model):
    ...
    rep = GraphRepresentation(ExampleWithSubsystemsBracketedArrayDefineModelInlineVariableBrackets())
    sim = Simulator(rep)
    sim.run()
