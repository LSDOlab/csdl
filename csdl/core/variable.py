...
# from csdl.core.operation import ElementwiseAddition, ElementwiseSubtraction, ElementwiseMultiplication, ElementwiseDivision, ElementwisePower
...
class Variable(Node):
    ...
    # TODO: remove dependencies when allowing CSDL to completely reorder
    # nodes
