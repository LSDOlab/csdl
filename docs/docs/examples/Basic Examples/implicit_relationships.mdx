...
import WorkedExample2 from './../../worked_examples/ex_bracketed_search_bracketed_scalar.mdx';

<WorkedExample2 />

Brackets may also be specified for multidimensional array values.

import WorkedExample3 from './../../worked_examples/ex_bracketed_search_bracketed_array.mdx';
