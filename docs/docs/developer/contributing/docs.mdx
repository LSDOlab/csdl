---
title: Building and Updating Documentation
sidebar_position: 2
---
...
:::warning
The `csdl/utils/generate_api_docs.sh` script must be run from within
`csdl/utils/` in order for the API docs to be written to the right
location.
