...
from openmdao.utils.parameters import Parameters, _undefined


class EmbedOptionsDirective(Directive):
    """
    EmbedOptionsDirective is a custom directive to allow an Parameters
    ...
    def run(self):
        ...
        if not isinstance(options, Parameters):
            raise TypeError("Object '%s' is not an Parameters." %
                            attribute_name)
